...
for (i = 0; i <= showSchedule.length - 1; i++) {
  var dataShow = showSchedule[i].date;
  var venueShow = showSchedule[i].venue;
  var venueLocation = showSchedule[i].location;
  ...
  dateAnnounced.appendChild(document.createTextNode(dataShow)); // posicao da data
  ...
  venueAnnounced.appendChild(document.createTextNode(venueShow)); // posicao do venue
  ...
  locationAnnounced.appendChild(document.createTextNode(venueLocation)); // posicao do local
